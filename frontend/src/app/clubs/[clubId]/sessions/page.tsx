  ...
  return (
    <ProtectedLayout>
      ...
      <main className="page-container">
        ...
        <PageHeader
          title="กิจกรรม"
          subtitle={`กิจกรรมทั้งหมดของ ${club?.name || 'ชมรม'}`}
          breadcrumbs={[
        ...
        {!isLoading && sessions && (
          <div className="flex items-center gap-4 text-sm text-neutral-500 mb-6">
            <span>
              ทั้งหมด <strong className="text-neutral-900">{filteredSessions.length}</strong> กิจกรรม
            </span>
            {statusFilter !== 'all' && (
        ...
        {!isLoading && filteredSessions.length === 0 && (
          <EmptyState
            icon={CalendarIcon}
            title={statusFilter !== 'all' ? 'ไม่พบกิจกรรม' : 'ยังไม่มีกิจกรรม'}
            description={
              statusFilter !== 'all'
                ? 'ลองเลือกสถานะอื่น หรือสร้างกิจกรรมใหม่'
                : 'สร้างกิจกรรมแรกของชมรม'
            }
            action={{
              label: 'สร้างกิจกรรม',
